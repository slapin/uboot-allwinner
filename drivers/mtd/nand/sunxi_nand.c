...
U_BOOT_CMD(nandrand, 2, 1,  do_switch_random,
	"switch AllWinner A1X NAND controller random generator on and off",
	"[on/off] - Switch \"on\" or \"off\" A1X's embedded NAND randomizer"
);
